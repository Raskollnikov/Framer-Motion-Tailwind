...
const Testimonials = () => {
  return (
    <div className="bg-[#f7f8fc] py-32" id="testimonials">
      <motion.div variants={fadeIn("up", 0.2)} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0.7 }}  className="container mx-auto pb-20">
        <div className="text-center mb-12">
            <h2 className="text-4xl font-secondary font-bold mb-3">What Our Clients Say</h2>
            <p className="text-lg mb-12 md:w-1/2 mx-auto">Hear from some of our satisfied clients about how our services have helped them achieve their goals.</p>
        </div>
              ...
              <div key={index} className="relative bg-white rounded-lg p-6 flex-1">
                ...
                <div className="flex flex-col space-y-3 mb-4">
                  ...
                  <div className="flex gap-1">
                    <img src={testimonial.image} className="size-16 rounded-full object-cover" alt="Reviewer Image" />
                    <div className="ml-2">
